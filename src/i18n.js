...
const i18n = {
  bg: {
    ...
    home: {
      ...
      tagline_top_right: "EST · 1992",
      title_a: "Аре­ти",
      title_b: "Завинаги",
      hero_kw: "Булчински и сватбени рокли Demetrios в София",
      lede: "Деликатна и съвременна булчинска мода, подбрана с внимание към всеки детайл.",
      scroll: "Разгледай",
      collection_eye: "Нашата колекция · 2026",
      collection_title: "Колекция",
      collection_title_em: "Demetrios",
      collection_meta_left: "100+ рокли · 5 силуета",
      collection_meta_right: "Demetrios · София",
      hero_meta: "100+ рокли · 5 силуета · 4 колекции",
      view_all: "Виж цялата колекция",
      story_eye: "За Арети",
      story_title: "Официален представител",
      story_title_em: "на Demetrios в България",
      story_p1: "Арети е официален представител на Demetrios в България от 1992 г. В нашия бутик в Лозенец, София, ще намерите над 100 рокли в 5 силуета — А-силует, русалка, принцеса, права линия и бохо — от четирите световни колекции Demetrios, Cosmobella, Platinum и Destination Romance.",
      story_p2: "Всяка рокля пристига директно от Demetrios. Нашият екип ви помага да намерите точния модел и осигурява безплатни корекции до деня на вашата сватба.",
      story_cta: "Историята",
      services_eye: "Опитът",
      services_title: "Един ден,",
      services_title_em: "за теб",
      service_1_title: "Лична консултация",
      service_1_desc: "90-минутна среща с консултант, чай, кафе и достъп до цялата колекция.",
      service_2_title: "Премерване и шев",
      service_2_desc: "Извършваме корекциите на място в салона напълно безплатно — от 3 до 6 седмици преди сватбата.",
      service_3_title: "Финална подготовка",
      service_3_desc: "Професионално отношение и грижовно съхранение на булчинската рокля при нас до деня на сватбата.",
      cta_band: "Запази час за проба при нас",
      cta_band_btn: "Резервирай час",
      reviews_eye: "— Отзиви от нашите булки —",
      reviews_title: "Какво казват",
      reviews_title_em: "клиентите",
      reviews_lede: "4.8 ★ от 266 Google отзива",
      reviews: [
        { q: "Дамите в Арети бяха невероятни — мили, търпеливи, страхотни професионалисти! Имах значими модификации на роклята, които изпълниха качествено и без забавяне.", n: "Mila Marinova" },
        { q: "Невероятно мили и професионални дами! Кети направи перфектно всички необходими корекции и се чувствах спокойно и уверено през цялото време. Препоръчвам Арети с две ръце!", n: "А. Добрева" },
        { q: "Не съм преживявала толкова прекрасно обслужване никъде в България. Още от първия момент бяха топли, мили и много внимателни.", n: "Patrisiya Ali Taleb" },
        { q: "Обиколих всички булчински бутици в София, но само Арети наистина ме впечатли. Роклите са повече от прекрасни — изработката, моделите и качеството са на много високо ниво.", n: "Боряна Михалкова" },
        { q: "Преминах през цялата страна, за да си купя сватбената рокля оттук. Живях в България целия си живот и се преместих във Великобритания. Когато дойде време да се омъжа, не исках друго място.", n: "Йоанна (Великобритания)" },
      ],
      reviews_link: "Виж всички в Google →",
    },
    collection: {
      crumb: "Начало / Колекция",
      title: "Колекция",
      title_em: "Demetrios",
      count: "100+ рокли · 2026",
      filter: "Филтри",
      sort: "Подреди",
      sort_new: "Най-нови",
      reset: "Изчисти",
    ...
    booking: {
      ...
      steps: ["Тип", "Дата", "Детайли"],
      step1_eye: "Стъпка 01 от 03",
      step1_title: "Тип",
      ...
      dress_required_hint: "За втора проба е задължително да изберете рокля, която вече сте пробвали — потърсете я в полето отдолу.",
      step3_eye: "Стъпка 02 от 03",
      step3_title: "Дата и",
      step3_title_em: "час",
      step3_help: "Изборът ти е за 90 минути. Препоръчваме среща поне 6 месеца преди сватбата.",
      step4_eye: "Стъпка 03 от 03",
      step4_title: "Твоите",
      step4_title_em: "детайли",
      step4_help: "Малко информация, за да се подготвим за теб.",
      types: [
        { tag: "Препоръчано", title: "Първа консултация", desc: "90 мин. с консултант, чай, кафе и достъп до цялата колекция без ограничение в броя рокли.", price: "30 €", note: "✓ Не е нужно да избирате рокля предварително", recommended: true },
      ...
      summary_rows: ["Тип", "Дата", "Час", "Име"],
      back: "Назад",
      next: "Напред",
      confirm: "Потвърди резервация",
      confirmation_title: "Готово.",
      confirmation_title_em: "До скоро.",
      confirmation_p: "Ще получиш потвърждение на имейла си в рамките на 24 часа. Очакваме те скоро.",
    ...
    blog: {
      ...
      read: "Прочети",
      cards: [
        { meta: "Силует · 6 мин", title: "Сирена или принцеса: какво подхожда на твоята фигура?", p: "Класически справочник за подбор на силует с примери от колекцията на Demetrios." },
    ...
    footer: {
      ...
      newsletter_btn: "",
      shop: "Магазин",
      shop_links: ["Булчински рокли", "Вечерни рокли", "Тест за рокля", "Контакти"],
      atelier: "Ателие",
      atelier_links: ["За нас", "За Деметриос", "Блог", "Контакти"],
      help: "Помощ",
      help_links: ["Резервирай час", "Тест: коя рокля ти отива", "Контакти", "Общи условия", "Поверителност", "Бисквитки"],
  ...
  en: {
    ...
    home: {
      ...
      title_a: "Are­ti",
      title_b: "Forever",
      hero_kw: "Demetrios wedding dresses in Sofia",
      lede: "Quiet, modern bridal fashion — curated with care for every detail.",
      scroll: "Discover",
      collection_eye: "Our Collection · 2026",
      collection_title: "The",
      collection_title_em: "Demetrios",
      collection_meta_left: "100+ dresses · 5 silhouettes",
      collection_meta_right: "Demetrios · Sofia",
      hero_meta: "100+ dresses · 5 silhouettes · 4 collections",
      view_all: "View entire collection",
      story_eye: "About Areti",
      story_title: "Official representative",
      story_title_em: "of Demetrios in Bulgaria",
      story_p1: "Areti is the official Demetrios representative in Bulgaria since 1992. Our boutique in Lozenets, Sofia carries over 100 dresses in 5 silhouettes — A-line, mermaid, ball gown, column and boho — from the four international collections Demetrios, Cosmobella, Platinum and Destination Romance.",
      story_p2: "Every gown arrives directly from Demetrios. Our team helps you find the perfect silhouette and provides complimentary alterations up to your wedding day.",
      story_cta: "Our story",
      services_eye: "The Experience",
      services_title: "One day,",
      services_title_em: "for you",
      service_1_title: "Private consultation",
      service_1_desc: "90 minutes with a stylist, tea, coffee and full access to the collection.",
      service_2_title: "Fitting & tailoring",
      service_2_desc: "Alterations done in-house and completely free — 3 to 6 weeks before your wedding day.",
      service_3_title: "Final preparation",
      service_3_desc: "Personal care and safe storage of your wedding dress at the boutique until the big day.",
      cta_band: "Book your fitting appointment",
      cta_band_btn: "Book a fitting",
      reviews_eye: "— Reviews from our brides —",
      reviews_title: "What our clients",
      reviews_title_em: "say",
      reviews_lede: "4.8 ★ from 266 Google reviews",
      reviews: [
        { q: "The team at Areti were incredible — kind, patient, true professionals. I had major alterations done beautifully and on time.", n: "Mila Marinova" },
        { q: "Wonderful, professional ladies! Kati did all the alterations perfectly and I felt calm and confident the whole time. I recommend Areti wholeheartedly.", n: "A. Dobreva" },
        { q: "I had never experienced such wonderful service anywhere in Bulgaria. From the very first moment they were warm, kind and very attentive.", n: "Patrisiya Ali Taleb" },
        { q: "I visited every bridal boutique in Sofia, but only Areti truly impressed me. The dresses are more than beautiful — craftsmanship and quality at the highest level.", n: "Boryana Mihalkova" },
        { q: "I travelled across the country to buy my wedding dress here. I lived my whole life in Bulgaria and moved to the UK. When the time came to marry, I wanted no other place.", n: "Yoanna (UK)" },
      ],
    ...
    product: {
      crumb_back: "Collection",
      designer: "Atelier Areti · 2026",
      ref: "Reference",
      price_from: "from",
    ...
    booking: {
      ...
      steps: ["Type", "Date", "Details"],
      step1_eye: "Step 01 of 03",
      step1_title: "Choose",
      ...
      dress_required_hint: "For a second fitting please select the dress you've already tried — find it in the search field below.",
      step3_eye: "Step 02 of 03",
      step3_title: "Date &",
      step3_title_em: "time",
      step3_help: "Your reservation lasts 90 minutes. We recommend visiting at least 6 months before the wedding.",
      step4_eye: "Step 03 of 03",
      step4_title: "Your",
      step4_title_em: "details",
      step4_help: "A little information so we can prepare for you.",
      types: [
        { tag: "Recommended", title: "First Consultation", desc: "90 min with a stylist, tea, coffee and full collection — no limit on number of dresses.", price: "30 EUR", note: "✓ No dress selection required", recommended: true },
      ...
      summary_rows: ["Type", "Date", "Time", "Name"],
      back: "Back",
      next: "Next",
      confirm: "Confirm reservation",
      confirmation_title: "All set.",
      confirmation_title_em: "See you soon.",
      confirmation_p: "You'll receive a confirmation email within 24 hours. We look forward to seeing you.",
    ...
    blog: {
      ...
      read: "Read",
      cards: [
        { meta: "Silhouette · 6 min", title: "Mermaid or princess: which suits your figure?", p: "A classical guide to silhouette selection with examples from the Demetrios collection." },
    ...
    footer: {
      ...
      newsletter_btn: "",
      shop: "Shop",
      shop_links: ["Wedding dresses", "Evening dresses", "Dress quiz", "Contact"],
      atelier: "Atelier",
      atelier_links: ["About us", "Demetrios", "Blog", "Contact"],
      help: "Help",
      help_links: ["Book a fitting", "Which dress suits you?", "Contact", "Terms & Conditions", "Privacy Policy", "Cookies"],
