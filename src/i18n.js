...
const i18n = {
  bg: {
    ...
    home: {
      ...
      collection_meta_left: "110+ силуета",
      collection_meta_right: "Demetrios · София",
      hero_meta: "110+ силуета · 5 колекции",
      view_all: "Виж цялата колекция",
      story_eye: "За Арети",
      story_title: "Официален представител",
      story_title_em: "на Demetrios в България",
      story_p1: "Арети е официален представител на Demetrios в България от 1992 г. В нашия бутик в Лозенец, София, ще намерите над 110 силуета от четирите световни колекции — Demetrios, Cosmobella, Platinum и Destination Romance.",
      ...
      service_1_desc: "90-минутна среща с консултант, чай и достъп до цялата колекция.",
    ...
    booking: {
      ...
      types: [
        { tag: "Препоръчано", title: "Първа консултация", desc: "90 мин. с консултант, чай и достъп до цялата колекция без ограничение в броя рокли.", price: "30 €", note: "✓ Не е нужно да избирате рокля предварително", recommended: true },
      ...
      size_options: ["XS (32–34)", "S (36)", "M (38)", "L (40)", "XL (42)", "XXL (44+)"],
      size_select: "Избери...",
      summary_rows: ["Тип", "Студио", "Дата", "Час", "Име", "Размер"],
      back: "Назад",
      next: "Напред",
  ...
  en: {
    ...
    home: {
      ...
      collection_title_em: "Demetrios",
      collection_meta_left: "110+ silhouettes",
      collection_meta_right: "Demetrios · Sofia",
      hero_meta: "110+ silhouettes · 5 collections",
      ...
      story_p1: "Areti is the official Demetrios representative in Bulgaria since 1992. Our boutique in Lozenets, Sofia carries over 110 silhouettes from four international collections — Demetrios, Cosmobella, Platinum and Destination Romance.",
      ...
      service_1_desc: "90 minutes with a stylist, tea, and full access to the collection.",
    ...
    booking: {
      ...
      types: [
        { tag: "Recommended", title: "First Consultation", desc: "90 min with a stylist, tea, and full collection — no limit on number of dresses.", price: "30 EUR", note: "✓ No dress selection required", recommended: true },
      ...
      size_options: ["XS (32–34)", "S (36)", "M (38)", "L (40)", "XL (42)", "XXL (44+)"],
      size_select: "Select...",
      summary_rows: ["Type", "Studio", "Date", "Time", "Name", "Size"],
      back: "Back",
      next: "Next",
