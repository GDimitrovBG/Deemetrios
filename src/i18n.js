...
const i18n = {
  bg: {
    ...
    home: {
      ...
      story_p2: "Колекциите ни за 2026 празнуват тихата сила на съвременната булка — без излишно, без шум.",
      story_cta: "Историята",
      services_eye: "Опитът",
    ...
    footer: {
      brand: "Арети",
      brand_em: "бг",
      tagline: "Бутикова булчинска кутюр, шита на ръка в София от 1992.",
  ...
  en: {
    ...
    home: {
      ...
      story_p2: "Our 2026 collections celebrate the quiet strength of the modern bride — nothing extra, no noise.",
      story_cta: "Our story",
    ...
    footer: {
      brand: "Are",
      brand_em: "ti",
      tagline: "Boutique bridal couture, hand-stitched in Sofia since 1992.",
