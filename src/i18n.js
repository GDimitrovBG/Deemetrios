...
const i18n = {
  bg: {
    ...
    home: {
      ...
      scroll: "Разгледай",
      collection_eye: "Нашата колекция · MMXXVI",
      ...
      story_p2: "Колекциите ни за MMXXVI празнуват тихата сила на съвременната булка — без излишно, без шум.",
      story_cta: "Историята",
      services_eye: "Опитът",
  ...
  en: {
    ...
    home: {
      ...
      scroll: "Discover",
      collection_eye: "Our Collection · MMXXVI",
      ...
      story_p2: "Our MMXXVI collections celebrate the quiet strength of the modern bride — nothing extra, no noise.",
      story_cta: "Our story",
