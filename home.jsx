...
function HomeHeroV1({ t, setRoute }) {
  return (
    <section className="hero hero-v1">
      <div className="hero-bg" style={{ backgroundImage: `url(${window.IMG.hero1})`, backgroundSize: "cover", backgroundPosition: "center" }}></div>
...
function HomeHeroV2({ t, setRoute }) {
  return (
    <section className="hero-v2">
      <div className="hero-img" style={{ backgroundImage: `url(${window.IMG.hero2})`, backgroundSize: "cover", backgroundPosition: "center" }}></div>
...
function HomeHeroV3({ t, setRoute }) {
  return (
    <section className="hero hero-v3">
      <div className="hero-bg" style={{ backgroundImage: `url(${window.IMG.hero3})`, backgroundSize: "cover", backgroundPosition: "center" }}></div>
      <div className="hero-content">
...
function CollectionPreview({ t, setRoute, lang }) {
  const dresses = window.DRESSES.slice(0, 6);
  return (
    <section className="section">
      <div className="sec-head">
        <div className="left">{t.home.collection_meta_left}</div>
        <h2>
          <span style={{ display: "block", fontSize: "0.42em", letterSpacing: "0.4em", color: "var(--ink-mute)", textTransform: "uppercase", marginBottom: 16 }}>{t.home.collection_eye}</span>
          {t.home.collection_title} <em>{t.home.collection_title_em}</em>
        </h2>
  ...
  return (
    <section className="section">
      <div className="editorial">
        <div>
          <Img src={window.IMG.about} label="atelier interior" className="editorial-img" />
        </div>
...
Object.assign(window, { HomePage, DressCard });
